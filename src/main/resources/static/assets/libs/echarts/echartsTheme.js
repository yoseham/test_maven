var myEchartsTheme = {
    ...
    title: {textStyle: {fontWeight: "normal", color: "#666",fontSize: 12},x:'center'},
    dataRange: {itemWidth: 20,itemHeight:15, color: ["#009688", "#e0ffff"]},
    ...
    grid: {borderColor: "#eee",x:20,y:40,x2:20,y2:20},
    categoryAxis: {
